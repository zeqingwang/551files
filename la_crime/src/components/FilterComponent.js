...
function FilterComponent({ filters, setFilters, onSearch }) {
    ...
    return (
        <div>
            ...
            <select value={filters.selectionType} onChange={e => setFilters({ ...filters, selectionType: e.target.value })}>
            ...
            <input type="number" placeholder="Latitude" value={latitude} onChange={e => setFilters({ ...filters, latitude: parseFloat(e.target.value) })} disabled={filters.selectionType !== 'pinpoint'} />
            <input type="number" placeholder="Longitude" value={longitude} onChange={e => setFilters({ ...filters, longitude: parseFloat(e.target.value) })} disabled={filters.selectionType !== 'pinpoint'} />
            <input type="number" placeholder="Radius" value={radius} onChange={e => setFilters({ ...filters, radius: parseFloat(e.target.value) })} disabled={filters.selectionType !== 'pinpoint'} />
